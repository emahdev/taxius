...
// home1
ScrollReveal().reveal('.payment-gateway-one .payment-infor', { delay: 200, origin: 'right' })
...
ScrollReveal().reveal('.payment-gateway-two .right', { distance: '200px', delay: 200, origin: 'right' })
ScrollReveal().reveal('.faqs-block .bg-surface .list-question >div:nth-child(1)', { delay: 250, origin: 'bottom' })
ScrollReveal().reveal('.faqs-block .bg-surface .list-question >div:nth-child(2)', { delay: 300, origin: 'bottom' })
ScrollReveal().reveal('.faqs-block .bg-surface .list-question >div:nth-child(3)', { delay: 350, origin: 'bottom' })
ScrollReveal().reveal('.faqs-block .bg-surface .list-question >div:nth-child(4)', { delay: 400, origin: 'bottom' })
ScrollReveal().reveal('.faqs-block .bg-surface .list-question >div:nth-child(5)', { delay: 450, origin: 'bottom' })
ScrollReveal().reveal('.faqs-block .desc .content', { delay: 250, origin: 'left' })
...
ScrollReveal().reveal('.benefit-two .heading3 ', { delay: 200, origin: 'bottom' })
ScrollReveal().reveal('.benefit-two .body1 ', { delay: 300, origin: 'bottom' })

// home3
ScrollReveal().reveal('.features-three .row .col-12:nth-child(2)', { delay: 300, origin: 'right' })

// home4
ScrollReveal().reveal('.case-studies-block.style-one.style-four .row .col-12:nth-child(1)', { delay: 200, origin: 'right' })
ScrollReveal().reveal('.case-studies-block.style-one.style-four .row .col-12:nth-child(2)', { delay: 400, origin: 'right' })
ScrollReveal().reveal('.case-studies-block.style-one.style-four .row .col-12:nth-child(3)', { delay: 600, origin: 'right' })
...
ScrollReveal().reveal('.blog-list.style-four .list-blog-related>a:nth-child(1)', { delay: 200, origin: 'right' })
ScrollReveal().reveal('.blog-list.style-four .list-blog-related>a:nth-child(2)', { delay: 400, origin: 'right' })
ScrollReveal().reveal('.blog-list.style-four .list-blog-related>a:nth-child(3)', { delay: 600, origin: 'right' })
...
// home6
ScrollReveal().reveal('.pricing-six .list-pricing .row .col-12:nth-child(1)', { delay: 200, origin: 'bottom' })
ScrollReveal().reveal('.pricing-six .list-pricing .row .col-12:nth-child(2)', { delay: 400, origin: 'bottom' })
ScrollReveal().reveal('.pricing-six .list-pricing .row .col-12:nth-child(3)', { delay: 600, origin: 'bottom' })
